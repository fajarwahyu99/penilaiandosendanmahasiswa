...
<tr>
	...
	<td width="327"><input type="text" name="namedepan" placeholder="<?php echo $buff['namadepan'];?>"/></td>
</tr> 
<tr>
	<td>Nama Belakang</td>
	<td><input type="text" name="namebelakang" placeholder="<?php echo $buff['namabelakang'];?>"/></td>
</tr>
<tr>
	<td>Username</td>
