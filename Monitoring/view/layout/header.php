...
<!-- Logo -->
        <a href="home" class="logo">
          ...
          <span class="logo-mini"><b>FAJAR</b>NUGRAHA</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>FAJAR</b> Monitoring</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo $admin_name; ?> Fajar Nugraha Wahyu- Web Developer
                      <small>PT.Fajar Nugraha Wahyu</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
