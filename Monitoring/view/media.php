...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Fajar Monitoring | ITCN3</title>
  ...
  <body class="sidebar-mini skin-yellow layout-boxed">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Fajar Simple Network Monitoring</b> 1.0
        </div>
        <strong>Copyright © <?php echo date("Y"); ?> <a href="http://fb.me/fajar.n.wahyu">Fajar Nugraha Wahyu</a>.</strong> All rights reserved.
      </footer>
    </div>
    <!-- /#wrapper -->
    <!-- jQuery 2.1.4 -->
