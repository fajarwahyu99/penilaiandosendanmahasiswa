        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menuItem"><a href="indexrelawan.php?module=home">Home</a></li>
                    <li class="menuItem"><a href="indexrelawan.php?module=rekap#rekap">Rekapitulasi</a></li>
                    <li class="menuItem"><a href="indexrelawan.php?module=inputdata#input" <?php if(isset($_GET['module'])) if($_GET['module']=="inputdata") echo "class='selected'";?>>Input Data</a></li>
