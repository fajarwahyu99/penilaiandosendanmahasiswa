...
<div class="rapidxwpr floatholder">
  ...
  <div id="header">
    ...
    <div id="topmenu">
	<ul>
      <li><a href="index.php?module=home"><span>HOME</span></a>
          <?php 
			if(isset($_SESSION['username'])){if($_SESSION['status']=="Admin"){
			?>
			<li><a href="index.php?module=daftardosen" <?php if(isset($_GET['module'])) if($_GET['module']=="daftardosen") echo "class='selected'";?>><span>DOSEN</span></a></li>
			<li><a href="index.php?module=daftarmhs" <?php if (isset($_GET['module'])) if($_GET['module']=="daftarmhs") echo "class='selected'";?>><span>MAHASISWA</span></a></li>
            <li><a href="index.php?module=daftarmatkul"<?php if(isset($_GET['module'])) if($_GET['module']=="lihatmatkul") echo "class='selected'";?>><span>PERKULIAHAN</span></a></li>
                        <li><a href="konten/logout.php"><span>LOGOUT</span></a></li>
            
		<?php
			} else if($_SESSION['status']=="Dosen"){
			?>
			<li><a href="index.php?module=inputnilai" <?php if (isset($_GET['module'])) if($_GET['module']=="inputnilai") echo "class='selected'";?>><span>PENILAIAN</span></a></li>
            <li><a href="konten/logout.php"><span>LOGOUT</span></a></li>
            
           <?php
			} else if($_SESSION['status']=="Mahasiswa"){
			?>
            <li><a href="index.php?module=lihatnilai" <?php if(isset($_GET['module'])) if($_GET['module']=="lihatnilai") echo "class='selected'";?>><span>LIHAT NILAI</span></a></li>
