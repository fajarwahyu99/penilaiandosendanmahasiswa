<?php
	...
	$edit="UPDATE user SET nama='$_POST[nama]', username='$_POST[username]', password='$_POST[password]', email='$_POST[email]'
...
<td>Password</td>
<td>:</td>
<td><input type="pasword" value="<?php echo $buff['password'];?>"name="password" required/></td>
</tr>
<tr>
<td>Email</td>
<td>:</td>
