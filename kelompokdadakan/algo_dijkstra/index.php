...
// select option
echo 'Cara Mencari Rute Angkot <br>';
echo 'Tentukan Kordinat anda di peta <br>';
echo 'Tentukan tujuan<br>';
echo 'Klik "Cari Rute"<br><br>';
...
echo '</select>';
?>
<span><button onclick="send_dijkstra()" id='run_dijkstra'>Cari Rute</button><span id='loading' style='display:none'>membuat rute ..</span></span>
