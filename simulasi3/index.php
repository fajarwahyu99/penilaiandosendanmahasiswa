    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			...
			<ul class="list-inline intro-social-buttons">
				<li><a href="login.php" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">LOGIN</span></a>
				</li>
	...
	<nav class="navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#home">QUICK JAKARTA</a>
			</div>

			<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					
					<li class="menuItem"><a href="#whatis">HASIL</a></li>
					<li class="menuItem"><a href="#useit">INFO</a></li>
					<li class="menuItem"><a href="#screen">CALON</a></li>
					<li class="menuItem"><a href="#credits">CREATOR</a></li>
...
include"konten/koneksi.php";
                    ...
                    <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                   <?php include"konten/koneksi.php";
    ...
    while($buff=mysql_fetch_array($hasil)){     
            ...
            <div class="col-lg-5 col-sm-6">
                <hr class="section-heading-spacer">
                   <div class="clearfix"></div>
                   <h2 class="section-heading">Hasil Hitung DKI JAKARTA</h2>
                   <p class="lead">Keterangan : 
                   <br>1. FAUZI BOWO DAN NACHROWI RAMLI<br>Perolehan Suara :
                   <?php echo $buff['t_s1'];?> 
                   <br>2. JOKO WIDODO DAN BASUKI TJAHAJA PURNAMA<br>Perolehan Suara : <?php
                   echo $buff['t_s2'];?>
                   <br>3. ALEX NOERDIN DAN NONO SAMPONO <br>Perolehan Suara : <?php
                   echo $buff['t_s3'];?>
                   </p>
                </div>
   ...
   <!--  <div class="content-section-a">
        ...
        <div class="container">
          <div class="row" >
			 <div class="col-md-6 col-md-offset-3 text-center wrap_title ">
				<h2>CALON GUBERNUR JAKARTA</h2>
				<p class="lead" style="margin-top:0">2012</p>
			 </div>
		  </div>
	...
	<div id="credits" class="content-section-a">
		<div class="container">
			...
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
				<h2>Pejuang</h2>
				<p class="lead" style="margin-top:0">Sejati</p>
			 </div>
			 
				<div class="col-sm-6  block wow bounceIn">
					<div class="row">
                      <!-- <div class="col-md-4 box-icon rotate"> --> 
                      <img src="img/1 copy.png" />
                        <!-- <i class="fa fa-picture-o fa-4x "> </i>  -->
                      </div>
						<div class="col-md-8 box-ct">
                        <h3> FAJAR NUGRAHA WAHYU </h3>
                        <p> </p> 
                      </div>
				  <!-- </div> -->
			  </div>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h3 class="footer-title">Kelompok 2</h3>
            <p>TUGAS UNTUK BANGSA<br/>
              MAJU TERUS INDONESIA KU<br/>
               <a  href="http://andreagalanti.it" target="_blank"></a>
            </p>
			
			<!-- LICENSE -->
			<a rel="cc:attributionURL" href="http://www.andreagalanti.it/flatfy"
		   property="dc:title">TEMA </a> by
		   <a rel="dc:creator" href="http://www.andreagalanti.it"
		   property="cc:attributionName">FAJAR</a>
		   GRATIS UNTUK SEMUA 
		   <BR>the <a rel="license"
		   href="http://creativecommons.org/licenses/by-nc/3.0/it/deed.it">GRATIS</a>.
          ...
          <div class="col-md-5">
            <div class="footer-banner">
              ...
              <ul>
               ...
               <a href="http://andreagalanti.it/flatfy" target="_blank"></a>
            </div>
          </div>
        </div>
      </div>
