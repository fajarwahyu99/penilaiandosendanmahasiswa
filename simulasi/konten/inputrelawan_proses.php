<?php
include "koneksi.php";
$mysql = "INSERT INTO relawan (id, nama, wilayah, no_telp, username, password) VALUES ('$_POST[id]', '$_POST[nama]', '$_POST[wilayah]', '$_POST[no_telp]', '$_POST[username]','$_POST[password]')";
$mysql1 = "INSERT INTO user (id, namadep, namabel, wilayah, telp, username, password, status) VALUES ('$_POST[id]', '$_POST[nama]',' ', '$_POST[wilayah]', '$_POST[no_telp]', '$_POST[username]','$_POST[password]','relawan')";
mysql_query($mysql);
...
echo"<script>alert('Data Berhasil Ditambahkan');window.location.href='?module=home';</script>";
mysql_close();
?>