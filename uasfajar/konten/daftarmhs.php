    ...
    <?php 	$mhs=mysql_query("SELECT * FROM mhs WHERE id='$aray[id_user]'");
		...
		<tr>
           ...
           <!--  <td align="center"><?php echo $aray['email']; ?></td> -->
			...
			<td align="center"><a href="home.php?module=editmhs&id=<?php echo $aray['id_user']; ?>">Edit</a></td>
            <td align="center"><a href="home.php?module=daftarmhs&aksi=hapus&id=<?php echo $aray['id_user']; ?>">Hapus</a></td>
